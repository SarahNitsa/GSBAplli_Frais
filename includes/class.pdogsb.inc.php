...
class PdoGsb
{
    ...
    public function majFraisForfait($idVisiteur, $mois, $lesFrais)
    {
     ...
     public function majFraisHorsForfait($id,$idVisiteur,$date,$mois ,$libelle, $montant)
    {
            $dateHF = dateFrancaisVersAnglais($date);
            $requetePrepare = PdoGSB::$monPdo->prepare(
                'UPDATE lignefraishorsforfait '
                . 'SET lignefraishorsforfait.montant = :unMontant, lignefraishorsforfait.date = :uneDate, lignefraishorsforfait.libelle = :unLibelle '
                . 'WHERE lignefraishorsforfait.idvisiteur = :unIdVisiteur '
    ...
    public function majTotal($idVisiteur, $leMois, $total, $nbj)
    {
        $requetePrepare = PdoGSB::$monPdo->prepare(
            'UPDATE fichefrais '
            . 'SET montantvalide = :total, nbjustificatifs = :unNb '
        ...
        $requetePrepare->bindParam(':unIdVisiteur', $idVisiteur, PDO::PARAM_STR);
        $requetePrepare->bindParam(':unMois', $leMois, PDO::PARAM_STR);
        $requetePrepare->bindParam(':unNb', $nbj, PDO::PARAM_INT);
        $requetePrepare->execute();
    }
    
    
    public function montantTotal($idVisiteur,$mois,$montant)
            {
        $requetePrepare = PdoGB::$monPdo->prepare(
            'UPDATE  fichefrais '
        ...
        $requetePrepare1 = PdoGB::$monPdo->prepare(
             'SELECT fichefrais.montantvalide FROM fichefrais '
            . 'WHERE fichefrais.mois = :unMois '
            . 'AND fichefrais.idvisiteur = :unIdVisiteur'
                
                 );
        $requetePrepare1->bindParam(':unIdVisiteur', $idVisiteur, PDO::PARAM_STR);
        $requetePrepare1->bindParam(':unMois', $mois, PDO::PARAM_STR);
        
         $montantvalide=$requetePrepare1->execute();
